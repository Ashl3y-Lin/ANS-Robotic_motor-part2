...
const questions = [
    {
        question: "What are the 2 ways you can make Motor A go down?" ,
        answers: [
            {text: "Motor A [Start(150)] , Motor A [counter-clockwise (150) degrees]", correct: false}, 
            {text: "Motor A [counter-clockwise (-150) degrees], Motor A [(150)degrees at speed (50)%]", correct: false}, 
            {text: "Motor A [left_speed: -50%] , Motor A [clockwise (150) degrees]", correct: false}, 
            {text: "Motor A [(-150)degrees at speed (50)%] , Motor A [counter-clockwise (150) degrees]", correct: true}, 
        ]
    },
    {
    ...
    {
        question: "How do you make the Motor A go UP?" ,
        answers: [
            {text: "Motor A [clockwise (-150) degrees]", correct: false}, 
            {text: "Motor A [clockwise (150) degrees]", correct: true}, 
            {text: "Motor A [(-150)degrees at speed (50)%]", correct: false}, 
            {text: "Motor A [(-150)degrees at speed (-50)%]", correct: false}, 
        ]
    },
    {
    ...
    {
        question: "how do you make the Motor A UP just a little bit and slow?" ,
        answers: [
